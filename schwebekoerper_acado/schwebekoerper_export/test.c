...
#define NUM_STEPS   30        /* Number of real-time iterations. */
...
int main( )
{
	...
	for (i = 0; i < N; ++i)  {
		...
		acadoVariables.y[ i*NY+2] =  48.760258862;
		acadoVariables.y[ i*NY+3] =  157.291157619;
	}
	acadoVariables.yN[ 0 ] = 1.0;
	...
	acadoVariables.x0[ 0 ] = 2.0;
	acadoVariables.x0[ 1 ] = -9.9;
	acadoVariables.x0[ 2 ] = 39.364;
#endif
